...
export default function Layout({ children }: LayoutProps) {
  ...
  const NavContent = () => {
    // Filtrar itens de navegação baseado no tipo de perfil
    const filteredNavItems = userType === "tutor" 
      ? navItems.filter(item => item.path === "/dashboard" || item.path === "/agendamentos")
      : navItems;
